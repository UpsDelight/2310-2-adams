...
<main>
    ...
    <section class="mv_low">
        <figure class="mv_low_bg">
            <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/common_low/img_mv_mask_2.png" alt="Contact お問い合わせ">
        </figure>
        <div class="mv_low_container">
            <h2 class="mv_low_ttl">
                <span class="ttl_en">about Business</span>
                <span class="ttl_jp">Contact Us</span>
            </h2>
        </div>
    </section>
    <!-- ↑↑ mv low ↑↑ -->
    ...
    <div class="breadcrumb">
        <ul class="breadcrumb_links">
            ...
            <li class="breadcrumb_link">Contact Us</li>
        </ul>
    </div>
    <!-- ↑↑ breadcrumb ↑↑ -->
    ...
    <section class="form_area">
        <div class="form_area_content">
            <div class="container">
                ...
                <p class="text_desc">Please fill out the form below to send a research request to us.</p>
                <p class="text_desc">
                    After entering your information, click Confirm to review your input.<br>
                    Click Submit when ready to submit the request.
                    <br>Fields marked with an asterisk (<span class="required">*</span>) must be filled out.
                </p>
            </div>
        </div>
