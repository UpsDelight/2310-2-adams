...
<main>
            ...
            <div class="table table_primary profile_table">
                ...
                <dl class="tr multi_line">
                    ...
                    <dd class="td">
                        ...
                        <a class="nav_link nav_link_cyan nav_link_underline has_icon_blank" href="https://www.aaa.co.jp/wordpress/wp-content/uploads/2023/07/dispatch-margin-rate-20210601.pdf" target="_blank" rel="noopener noreferrer">派遣マージン率はこちら <img class="icon_blank" src="<?php echo get_template_directory_uri(); ?>/assets/images/common/icon/icon_blank_line.png" alt="icon blank"></a>
                    </dd>
                </dl>
                <dl class="tr one_line">
                    <dt class="th">資本金</dt>
 ...
            <p class="text_lead">健康経営優良法人2023</p>
        ...
        <section class="history ani fadein" id="target_3">
            ...
            <div class="ani fadein">
                ...
                <p class="timeline">
                    ...
                    <span class="detail">
                        一般社団法人　<br class="sp_block">日本マーケティング・リサーチ協会（JMRA）<br class="sp_block">加盟正会員
                    </span>
                </p>
                <p class="timeline">
                    ...
                    <span class="month">7月</span>
                    <span class="detail">
                        CATIシステム<br class="sp_block">（コンピュータによる電話調査システム）<br class="sp_block">を導入
                    </span>
                </p>
                <p class="timeline">
                ...
                <p class="timeline">
                    ...
                    <span class="detail">
                        米国ハリスインタラクティブ社と<br class="sp_block">提携・合弁事業化
                    </span>
                </p>
                <p class="timeline">
