...
<!-- ↓↓ mv low ↓↓ -->
    <section class="mv_low">
        ...
        <div class="mv_low_container">
            <h2 class="mv_low_ttl ani fadein">
                ...
                <span class="ttl_jp">その他に関するお問い合わせ - 確認画面</span>
            </h2>
        </div>
    </section>
    <!-- ↑↑ mv low ↑↑ -->
    ...
    <div class="breadcrumb">
        <ul class="breadcrumb_links ani fadein">
            ...
            <li class="breadcrumb_link">モニターに関するお問い合わせ - 確認画面</li>
        </ul>
    </div>
    <!-- ↑↑ breadcrumb ↑↑ -->
	<!-- ↓↓ form content ↓↓ -->
    <section class="form_area">
        <div class="form_area_content ani fadein">
            <div class="container">

                <h3 class="c_low_ttl02">お問い合わせをされる方へ</h3>
                <p class="text_desc">入力内容をご確認ください。</p>
            </div>
        </div>
