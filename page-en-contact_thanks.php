...
<!-- ↓↓ mv low ↓↓ -->
    <section class="mv_low">
        ...
        <div class="mv_low_container">
            <h2 class="mv_low_ttl">
                ...
                <span class="ttl_jp">Contact Us - Thanks</span>
            </h2>
        </div>
    </section>
    <!-- ↑↑ mv low ↑↑ -->
    ...
    <div class="breadcrumb">
        <ul class="breadcrumb_links">
            ...
            <li class="breadcrumb_link">Contact Us - Thanks</li>
        </ul>
    </div>
    <!-- ↑↑ breadcrumb ↑↑ -->
	<!-- ↓↓ form content ↓↓ -->
    <section class="form_area">
        <div class="form_area_content">
            <div class="container thanks_padding">

                <h3 class="c_low_ttl02">Thank you for your inquiry about our service this time</h3>
                <p class="text_desc">
					We will send you a confirmation email to those who inquired, we will reply again from the person in charge, so thank you.
				</p>
				<a href="<?php echo home_url('/en'); ?>" class="to_topbutton">to TOP</a>
            </div>
        </div>
