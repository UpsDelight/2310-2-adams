        ...
        <div class="survey-monitor-intro__inner container">
            ...
            <div class="survey-monitor-intro__wrap">
                <p class="survey-monitor-intro__text">
                    私ども株式会社アダムスコミュ二ケーションは、1979年設立以来、マーケティングリサーチ、世論調査を通して消費者（調査対象者）の態度や意見、実態等を統計情報として取扱い、顧客である企業や公共機関等に提供している、市場調査専門会社です。<br>
                    <br>
                    その際の個人情報の保護については、国内法及びマーケティングリサーチ業界の国際的行動規範である「ICC/ESOMAR国際綱領」、一般社団法人日本マーケティング・リサーチ協会の「マーケティング・リサーチ綱領」を遵守しております。<br>
                    <br>
                    現在私どもでは「アダムスモニターパネル」のメンバーにご登録いただける方を募集しております。<br>
                    ご登録いただきました方には、様々な方法での調査にご協力をお願いしております。<br>
                    <br>
                    ご協力いただきました際には、ポイント（グリーンスタンプ株式会社の運営する「My GreenStamp」）、QUOカード、図書カード、商品券などの謝礼を用意しております。（但し、謝礼額・謝礼の種類はその都度異なります）
                </p>
                    ...
                    <?php $faq_groups = [
                        [
                            ...
                            'faq_qa_items' => [
                                ...
                                ['question' => '会員になるための条件はありますか？', 'answer' => '株式会社アダムスコミュニケーションが実施するインターネット・電話によるアンケート にご協力いただける、日本国内に住む満15歳以上（中学校卒業以上）の方で、ご自身または同居される家族の方が、広告代理店、市場調査会社、マスコミ関係のいずれにも勤務していないことが条件になります。<br><br>詳しくは、<a class="faq-group__a-link" href="#monrle" target="_blank">アダムスモニターパネル規約（第三条　入会資格）</a>をご確認ください。'],
                        ...
                        [
                            ...
                            'faq_qa_items' => [
                                ['question' => '会員IDを忘れてしまった場合は、どうすれば良いのですか？', 'answer' => '会員IDは会員本登録が完了した後にお送りするEメールに記載されております。<br>紛失して会員IDが確認できない場合は、アダムスモニターパネル事務局へEメール（氏名・生年月日・住所をお書き添えください）、またはお電話でお問い合わせください。<br>⇒ <a class="faq-group__a-link" href="' . $contact_other_url . '" target="_blank">お問い合わせはこちらから</a>'],
                    ...
                    <ul class="survey-faq__groups">
                        <?php foreach ($faq_groups as $i => $faq_group) : ?>
                            <li id="nav-faq-0<?= $i ?>" class="survey-faq__group faq-group">
                                ...
                                <?php foreach ($faq_group['faq_qa_items'] as $faq_qa_item) : ?>
                                    <details class="faq-group__accordion js-accordion">
                        ...
                        <?php $scroll_contents_monrle = [
                            ...
                            [
                                ...
                                'content_items' => [
                                    ...
                                    電話：<a class=\"scroll__content-tel\" href=\"tel:0120-373-548\">0120-373-548</a><br>
                                    <a class=\"scroll__content-link\" href=\"mailto:privacy@kir338815.kir.jp\">privacy@kir338815.kir.jp</a>"
                                ]
                            ],
                            [
                        ...
                        <ul class="scroll__contents">
                            <li class="scroll__content">
                                ...
                                <?php $scroll_content_items_privacy = [
                                    ...
                                    "(株)アダムスコミュニケーションが個人情報を取り扱うにあたっては、個人情報の取り扱いに関する法令や国が定める指針、及び当社加盟の一般社団法人日本マーケティング・リサーチ協会が定める「マーケティング・リサーチ綱領」「マーケティング・リサーチ産業　個人情報保護ガイドライン」、マーケティング・リサーチ業界の国際的行動規範である「ICC／ESOMAR国際綱領」、その他の規範を遵守いたします。",
