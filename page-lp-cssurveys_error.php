<?php 
/* Template Name: lp_cssurveys_error */
get_header("lp"); ?>
<!--▼ Content area ▼-->
<main class="p-top p-contact p-contact_blue">
  <div class="c__mv">
    <div class="mv__img">
      <img class="only__pc" src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_mv_1.webp" alt="  医療・ヘルスケア業界向け製品・ソリューション利用者向けサポートコールセンター事例" />
      <img class="only__sp" src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_mv_1.webp" alt="  医療・ヘルスケア業界向け製品・ソリューション利用者向けサポートコールセンター事例" />
    </div>
    <div class="decor">
    ...
    <div class="form01 js_form01">
      ...
      <div class='form error'>
        <?php echo do_shortcode('[mwform_formkey key="510"]'); ?>
      </div>
        ...
        <div class="point__content">
          ...
          <div class="point__list">
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point04.webp" alt="医療機関様との連携" />
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point05.webp" alt="綜合満足度と項目別満足度を数値化" />
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point06.webp" alt="項目別重要度も聴取" />
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point07.webp" alt="効率のよい満足度向上策" />
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point08.webp" alt="満足度レベルによるパターン分析" />
            ...
            <div class="item" data-aos="fade-up" data-aos-delay="200">
              <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_point09.webp" alt="わかりやすいアウトプット" />
      ...
      <div class="c__content">
        ...
        <div class="point__list">
          <a href="https://www.aaa.co.jp/contactcenter" target="_blank" class="item" data-aos="fade-up" data-aos-delay="200">
            <div class="img">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_articles01.webp" alt="コンタクトセンター" />
            </div>
            <div class="item__desc">
              <p class="sub">
          ...
          <a href="https://www.aaa.co.jp/research" target="_blank" class="item" data-aos="fade-up" data-aos-delay="200">
            <div class="img">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_articles02.webp" alt="リサーチ" />
            </div>
            <div class="item__desc ">
              <p class="sub">
                <span class="sub__name">BLOG</span>
          ...
          <a href="https://www.aaa.co.jp/insidesales" target="_blank" class="item" data-aos="fade-up" data-aos-delay="200">
            <div class="img">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lp/img_articles03.webp" alt="インサイドセールス" />
            </div>
            <div class="item__desc ">
              <p class="sub">
                <span class="sub__name">BLOG</span>
